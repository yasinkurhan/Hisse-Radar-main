...
app = FastAPI(
    ...
    * **Teknik Analiz** - RSI, MACD, Bollinger, ADX, Fibonacci, OBV
    ...
    * **Portfoy** - Sanal portfoy simulasyonu
    ...
    Veriler yfinance API uzerinden gecikmeli olarak alinmaktadir (15-20 dk gecikme).
    """,
    version="2.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
...
async def root():
    ...
    return {
        ...
        "version": "2.0.0",
        "description": "BIST Hisse Analiz Platformu - Gelismis Teknik ve Temel Analiz",
        "docs": "/docs",
        "features": [
            "500+ BIST hissesi analizi",
            "Gelismis teknik gostergeler (ADX, Fibonacci, OBV)",
            "Formasyon tespiti",

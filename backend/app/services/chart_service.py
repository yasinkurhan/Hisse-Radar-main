...
class ChartService:
    ...
    def get_ohlc_data(self, symbol: str, period: str = "3mo", interval: str = "1d") -> Dict[str, Any]:
        ...
        try:
            ...
            # Veriyi çek
            df = fetcher.get_history(ticker_symbol, period=period, interval=interval)
            ...
            # Hisse bilgisi - yahoo_fetcher'dan al
            price_info = fetcher.get_current_price(ticker_symbol)
    ...
    def get_sector_heatmap(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for stock in stocks[:100]:  # İlk 100 hisse için
                ...
                try:
                    hist = fetcher.get_history(f"{symbol}.IS", period="2d", interval="1d")
    ...
    def get_comparison_data(self, symbols: List[str], period: str = "1y") -> Dict[str, Any]:
        ...
        try:
            ...
            for symbol in symbols:
                try:
                    hist = fetcher.get_history(f"{symbol}.IS", period=period, interval="1d")
                    ...
                    # Hisse bilgisini al
                    price_info = fetcher.get_current_price(f"{symbol}.IS")
                    ...
                    stocks_data.append({
                        ...
                        "minPrice": round(float(hist["Low"].min()), 2),
                        "maxPrice": round(float(hist["High"].max()), 2)
                    })

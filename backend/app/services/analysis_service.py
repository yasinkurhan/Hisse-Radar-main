...
==========================
Gunluk ve haftalik teknik analiz yaparak hisse onerileri uretir
...
class AnalysisService:
    ...
    def _fetch_sentiment_sync(self, symbol: str) -> Dict[str, Any]:
    ...
    def _analyze_single_stock(self, symbol: str, period: str = "3mo", interval: str = "1d", analysis_type: str = "daily", retry_count: int = 3, include_sentiment: bool = True) -> Optional[Dict[str, Any]]:
        """Tek bir hisse icin analiz yap - retry mekanizmasi ve sentiment ile"""
        last_error = None
        ...
        for attempt in range(retry_count):
            try:
                ...
                # Her denemede kisa bekleme
                if attempt > 0:
                    time.sleep(0.5 * attempt)
                
                # Yeni yahoo_fetcher kullan (yfinance yerine)
                ...
                if include_sentiment:
                    try:
                        sentiment_data = self._fetch_sentiment_sync(symbol)

      ...
      <div className="p-4">
        {activeTab === 'overview' && ratios && (
          <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    <p className={`text-lg font-bold flex items-center gap-1 ${
                      (growth.yoy_revenue_growth || 0) >= 0 ? 'text-green-400' : 'text-red-400'
                    }`}>
                  ...
                  <div>
                    ...
                    <p className={`text-lg font-bold flex items-center gap-1 ${
                      (growth.yoy_profit_growth || 0) >= 0 ? 'text-green-400' : 'text-red-400'
                    }`}>
                  ...
                  <div>
                    ...
                    <p className={`text-lg font-bold ${
                      (growth.cagr_3y_revenue || 0) >= 0 ? 'text-green-400' : 'text-red-400'
                    }`}>
            ...
            {/* Analist Hedefi */}
            {valuation && valuation.target_mean && (

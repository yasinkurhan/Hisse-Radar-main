          ...
          <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-14 sm:h-16">
              ...
              <nav className="hidden md:flex items-center space-x-4 lg:space-x-6">
                <Link
                  href="/analysis"
                  className="text-slate-300 hover:text-primary-400 transition-colors font-medium text-sm lg:text-base"
                >
                  Analiz
                </Link>
                <Link
                  href="/market"
                  className="text-slate-300 hover:text-primary-400 transition-colors font-medium flex items-center gap-1 text-sm lg:text-base"
                >
          ...
          <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
              ...
              <div className="mt-3 md:mt-0 text-slate-500 text-xs">
                ...
                <p className="mt-1">
                  Veriler 15-20 dakika gecikmeli olarak yfinance API&apos;den alınmaktadır.
                </p>
              </div>
            </div>
          </div>

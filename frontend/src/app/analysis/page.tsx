  ...
  useEffect(() => {
    ...
    const fetchPerformance = async () => {
      try {
        ...
        console.error('Performans verisi alınamadı:', e);
      }
    };
    fetchPerformance();
  }, []);
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4">
                  <div className="bg-gray-900/50 rounded-lg p-3 sm:p-4 text-center">
                    ...
                    <p className={`text-lg sm:text-2xl font-bold ${
                      result.market_summary.avg_sentiment > 0.1 ? 'text-green-400' :
                    ...
                    {stock.sentiment?.has_data && (
                      <div className="mt-2 text-xs text-center">
                        <span className={`px-2 py-0.5 rounded ${
                          stock.sentiment.score > 0.2 ? 'bg-green-500/20 text-green-400' :
